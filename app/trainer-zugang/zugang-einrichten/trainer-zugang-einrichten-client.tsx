...
export function TrainerZugangEinrichtenClient() {
      ...
      <div className="min-h-screen bg-zinc-50 px-4 py-6 text-zinc-900 md:px-6 md:py-8">
        <div className="mx-auto max-w-xl space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-[24px] bg-white p-3 shadow-sm">
            <div className="rounded-2xl bg-[#154c83] px-4 py-2 text-sm font-semibold text-white">Trainerzugang einrichten</div>
            ...
            {done ? (
              ...
              <>
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 text-sm text-zinc-700">
                  Lege jetzt dein persönliches Passwort fest. Danach kannst du dich nach Admin-Freigabe im Trainerbereich anmelden.
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-zinc-500">{TRAINER_PIN_HINT}</p>
                  </div>
